...
public class EncodedEntityStructure {
	...
	/**
	 * @return 
	 * array encoding the property values  [entityPosition][property Position][value id][token ID]
	 */
	...
	/**
	 * @return 
	 * array encoding the property values  [entityPosition][property Position][value id][trigram ID]
	 */
